...
Создать основной код по описанию классов и их содержимого (скрин 1- пункт 1-5 в таблице заполнения + и - по заданиям), выполнить тест 1 Вызовите справку по садоводству  (скрин 2).
### Результат.
