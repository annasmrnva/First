...
### Результат.
![Меню](https://github.com/annasmrnva/First/blob/%D0%A2%D0%B5%D0%BC%D0%B0_9/pic/2024-10-21%20(20).png)
...
Создать основной код по описанию классов и их содержимого (скрин 1- пункт 1 в таблице заполнения + и - по заданиям), выполнить тест 1 (пункт 2) Вызовите справку по садоводству  (скрин 2).
### Результат.
![Меню](https://github.com/annasmrnva/First/blob/%D0%A2%D0%B5%D0%BC%D0%B0_9/pic/2024-10-21%20(35).png)
...
### Результат.
![Меню](https://github.com/annasmrnva/First/blob/%D0%A2%D0%B5%D0%BC%D0%B0_9/pic/2024-10-21%20(38).png)
## Выводы
...
## Выводы
Увеличиваем количество уходов за растениями (вызываем метод work трижды), чтобы дать всем помидорам дозреть до состояния "красный". Затем снова вызываем метод harvest, чтобы собрать урожай. Этот тест показывает, как можно успешно собрать урожай после полного созревания всех помидоров.
